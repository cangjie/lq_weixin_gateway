        ...
        { 
            case "subscribe":
                ...
                if (!deal)
                {
                    ...
                    newsArr[0].picUrl = "http://mmbiz.qpic.cn/mmbiz/2x9sALwpIbX0W11UKx4TbscXMBgH0yEick709GA9OGMhgnZ3WMXS3p3Ekak4ov6OPibcbJ5b1zb7skqXXPGrzM2Q/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1";
                    newsArr[0].title = "北欧游学之旅摄影大赛评比，需要您的热情参与！";
                    newsArr[0].description = newsArr[0].title.Trim();
                    newsArr[0].url = "http://mall.luqinwenda.com/europevote/default.aspx";

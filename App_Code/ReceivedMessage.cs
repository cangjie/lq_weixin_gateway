...
public class ReceivedMessage
{
            ...
            case "event":
                ...
                { 
                    ...
                    case "merchant_order":
                        try
                        {
                            orderId = xmlD.SelectSingleNode("//xml/OrderId").InnerText.Trim();
                        }
                        catch
                        {
                            orderId = "";
                        ...
                        try
                        {
                            orderStatus = xmlD.SelectSingleNode("//xml/orderStatus").InnerText.Trim();
                        }
                        catch
                        {
                            orderStatus = "";
                        ...
                        try
                        {
                            productId = xmlD.SelectSingleNode("//xml/ProductId").InnerText.Trim();
                        }
                        catch
                        {
                            productId = "";
                        ...
                        try
                        {
                            skuInfo = xmlD.SelectSingleNode("//xml/SkuInfo").InnerText.Trim();
                        }
                        catch
                        {
                            skuInfo = "";
    ...
    public static bool SaveToDatabase(ReceivedMessage receivedMessage)
    {
        string sqlStr = " insert into wxreceivemsg ("
            ...
            + " wxreceivemsg_orderid, "
            + " wxreceivemsg_orderstatus, "
            + " wxreceivemsg_productid, "
            + " wxreceivemsg_skuinfo, "
            ...
            + "'" + receivedMessage.orderId.Trim().Replace("'", "") + "'  , "
            + "'" + receivedMessage.orderStatus.Trim().Replace("'", "") + "'  , "
            + "'" + receivedMessage.productId.Trim().Replace("'", "") + "'  , "
            + "'" + receivedMessage.skuInfo.Trim().Replace("'", "") + "'  , "

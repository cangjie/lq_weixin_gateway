    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                Response.Redirect("payment_goto_bank.aspx?timestamp=" + timeStamp.Trim() + "&noncestr="
                    + nonce_str.Trim() + "&prepayid=" + prepayId.Trim(), true);
                /*
                string jsParameterStr = "timestamp=" + timeStamp.Trim() + "&nonceStr=" + nonce_str.Trim()
                    + "&package=prepay_id=" + prepayId.Trim() + "&signType=MD5";
                jsParameterStr = Util.GetSortedArrayString(jsParameterStr);
                string jsMd5 = Util.GetMd5(jsParameterStr);
                jsPatameter = "timestamp:" + timeStamp.Trim() + ",\r\n"
                    + "nonceStr:'" + nonce_str.Trim() + "',\r\n"
